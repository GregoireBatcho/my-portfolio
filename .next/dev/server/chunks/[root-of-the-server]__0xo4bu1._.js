...
"[project]/src/app/api/cv/download/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const profile = __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getProfile();
        if (!profile.cvBase64) {
            ...
            if (profile.cvUrl && profile.cvUrl !== '/api/cv/download' && profile.cvUrl !== '#') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(profile.cvUrl));
            }
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('CV file has not been uploaded to MongoDB Atlas yet.', {
                status: 404
            });
        }
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`Error retrieving CV: ${e.message}`, {
            status: 500
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0xo4bu1._.js.map