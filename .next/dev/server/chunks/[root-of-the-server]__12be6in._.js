...
"[project]/src/app/api/technologies/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, { params }) {
    ...
    try {
        ...
        const updated = __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].updateTechnology(id, body);
...
async function DELETE(req, { params }) {
    ...
    try {
        const { id } = await params;
        __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].deleteTechnology(id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12be6in._.js.map