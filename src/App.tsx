            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-8 border-y border-stone-200 dark:border-zinc-900/80">
                {[
                  ...
                  { value: '450+', label: t('about.statsCoffee') }
                ].map((stat, idx) => (
                  <div key={idx} className="p-6 rounded-2xl border border-stone-200 bg-white dark:border-zinc-900 dark:bg-neutral-900/20 text-center shadow-sm dark:shadow-none">
                    <span className="text-3xl font-bold font-display text-stone-900 dark:text-white">{stat.value}</span>
                    <span className="block text-[10px] text-[#d97736] font-mono mt-2 uppercase tracking-wider">{stat.label}</span>
                  </div>
                ))}
              </div>
                ...
                <div className="lg:col-span-4 space-y-6">
                  <div className="p-6 rounded-2xl border border-stone-200 bg-white dark:border-zinc-800 dark:bg-[#0c0a09]/80 backdrop-blur luxury-glow space-y-5">
                    ...
                    <div className="space-y-1.5 font-mono text-[9px] text-stone-500 dark:text-zinc-500 uppercase tracking-widest">
                      <p>{t('about.fullnameLabel')}: {profile?.fullname}</p>
                      <p>{t('about.locationLabel')}: {profile?.location}</p>
                      <p>{t('about.availabilityLabel')}: {profile?.availability ? t(`common.${profile.availability}`) : ''}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-12 border-t border-stone-200 dark:border-zinc-900/60 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {softSkills.map((skill) => (
                    <div key={skill.id} className="p-6 rounded-2xl border border-stone-200 bg-white/80 dark:border-zinc-900 dark:bg-neutral-900/25 space-y-3 hover-glow transition-all shadow-sm dark:shadow-none">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 p-8 md:p-10">
                <main className="lg:col-span-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-5 pt-3">
                    <div className="p-5 rounded-2xl border border-stone-200 dark:border-zinc-800 bg-stone-50/50 dark:bg-neutral-900/20">
                      <h5 className="text-stone-800 dark:text-white font-display font-medium text-xs tracking-wide mb-2 flex items-center gap-1.5 uppercase">
                        <Terminal className="w-3.5 h-3.5 text-stone-500 dark:text-zinc-500" />
                        {t('projects.challenges')}
                      </h5>
                      <p className="text-stone-600 dark:text-zinc-400 text-xs leading-relaxed font-sans">
                        Ensuring responsive performance under extreme database loads, which we mitigated through custom dynamic data-pooling algorithms on the server Node.js.
                      </p>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl border border-stone-200 dark:border-zinc-800 bg-stone-50/50 dark:bg-neutral-900/20">
                      ...
                      <p className="text-stone-600 dark:text-zinc-400 text-xs text-[11px] leading-relaxed font-sans font-medium">
                        Implemented robust caching strategies, database metric pipelines, and precise visual animations that guide smooth navigation.
                      </p>
                    </div>
                  </div>
                </main>
                ...
                <aside className="lg:col-span-4 space-y-6 shrink-0 lg:border-l lg:border-stone-200 lg:dark:border-zinc-800 lg:pl-6">
                  ...
                  <div>
                    ...
                    <p className="text-stone-800 dark:text-white text-xs font-mono">
                      {selectedProject.startDate} {selectedProject.endDate ? `– ${selectedProject.endDate}` : "– Active"}
                    </p>
                  </div>
