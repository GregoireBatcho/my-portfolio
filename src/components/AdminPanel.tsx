...
export default function AdminPanel({ onUpdate }: AdminPanelProps) {
  ...
  const [editingCat, setEditingCat] = useState<Partial<ProjectCategory> | null>(
    null,
  );
  const [editingExp, setEditingExp] = useState<Partial<Experience> | null>(
    null,
  );
    ...
    try {
      const response = await fetch("/api/seo", {
        ...
        body: JSON.stringify({
          ...editingSeo,
          keywords:
            typeof editingSeo.keywords === "string"
              ? (editingSeo.keywords as string)
                  .split(",")
                  .map((k: string) => k.trim())
              : editingSeo.keywords,
        }),
  ...
  const handleSaveProject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const formattedProj = {
        ...editingProj,
        technologies:
          typeof editingProj.technologies === "string"
            ? (editingProj.technologies as string)
                .split(",")
                .map((t: string) => t.trim())
            : editingProj.technologies,
        images:
          typeof editingProj.images === "string"
            ? (editingProj.images as string)
                .split(",")
                .map((i: string) => i.trim())
            : editingProj.images,
      };
  ...
  const handleDeleteCategory = async (id: string) => {
    if (
      !confirm(
        "Are you sure you want to delete this category? All projects in this category will need update.",
      )
    )
      return;
    try {
  ...
  const handleSaveExp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const formattedExp = {
        ...editingExp,
        technologies:
          typeof editingExp.technologies === "string"
            ? (editingExp.technologies as string)
                .split(",")
                .map((t: string) => t.trim())
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <p className="text-center text-[10px] font-mono text-zinc-600 mt-4 leading-relaxed">
              ...
              <span className="text-[#d97736] font-semibold bg-zinc-950 px-1.5 py-0.5 rounded border border-zinc-900">
                gregoire2026
              </span>
            </p>
          </form>
        ...
        <aside className="w-full lg:w-72 shrink-0 space-y-6">
          <div className="p-6 rounded-2xl border border-stone-200 dark:border-zinc-800 bg-white dark:bg-neutral-900/30 flex items-center justify-between shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-stone-900 dark:text-white text-xs font-semibold tracking-wider font-display uppercase">
                  {t("admin.sidebarTitle")}
                </h4>
                <span className="text-[10px] font-mono text-stone-500 dark:text-zinc-505 uppercase tracking-widest block">
                  {t("admin.sidebarRole")}
                </span>
              </div>
            </div>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-stone-500 dark:text-zinc-500 text-[10px] font-mono uppercase tracking-widest">
                          {card.title}
                        </span>
                        <card.icon
                      ...
                      <div>
                        <h4 className="text-2xl font-bold font-display text-stone-900 dark:text-white mt-1">
                          {card.value}
                        </h4>
                        <p className="text-[10px] text-stone-500 dark:text-zinc-400 font-mono mt-1">
                          {card.label}
                        </p>
                      </div>
                    </div>
                ...
                {!editingProfile ? (
                  <div className="space-y-6 text-xs text-stone-700 dark:text-zinc-300">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50/50 dark:bg-neutral-900/20 p-5 rounded-2xl border border-stone-200 dark:border-zinc-800 shadow-sm luxury-glow">
                      <div>
                        <span className="text-stone-400 dark:text-zinc-500 font-mono text-[9px] uppercase tracking-widest block mb-1">
                          Full Display Name
                        </span>
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-stone-900 dark:text-white text-sm font-semibold capitalize">
                    ...
                    <div>
                      <span className="text-stone-500 dark:text-zinc-500 font-mono text-[9px] uppercase tracking-widest block mb-2">
                        {t("admin.bioSummary")}
                      </span>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="p-4 bg-stone-50/50 dark:bg-neutral-900/20 rounded-xl border border-stone-200 dark:border-zinc-800 shadow-xs">
                        ...
                        <p className="text-stone-700 dark:text-zinc-300 font-mono truncate">
                      ...
                      <div className="p-4 bg-stone-50/50 dark:bg-neutral-900/20 rounded-xl border border-stone-200 dark:border-zinc-800 shadow-xs">
                        ...
                        <div className="flex items-center gap-3 mt-1 bg-stone-50 dark:bg-zinc-950/40 p-2.5 rounded-lg border border-stone-200 dark:border-zinc-850 shadow-sm">
                          ...
                          <p className="text-stone-700 dark:text-zinc-300 font-mono truncate text-[11px] flex-1">
                            {profile.profilePicture}
                          </p>
                        </div>
                      </div>
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-stone-500 dark:text-zinc-500 text-[10px] uppercase font-mono tracking-widest mb-1">
                          Fullname
                        </label>
                        <input
                          type="text"
                    ...
                    <h4 className="text-stone-900 dark:text-white text-xs font-semibold font-display tracking-wider border-b border-stone-200 dark:border-zinc-900 pb-2.5 pt-3 uppercase">
                      Social links, profile picture & resume file
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-stone-500 dark:text-zinc-500 text-[10px] uppercase font-mono tracking-widest mb-1">
                      ...
                      <div>
                        <label className="block text-stone-500 dark:text-zinc-505 text-[10px] uppercase font-mono tracking-widest mb-1">
                          {t("admin.bioLinkedin")}
                        </label>
                        <input
                          type="text"
              ...
              <div className="space-y-6">
                ...
                {!editingProj ? (
                  ...
                  >
                    ...
                    <div>
                      <label className="block text-stone-500 dark:text-zinc-500 text-[10px] uppercase font-mono tracking-widest mb-1">
                        Project Images (Comma lists of URLs)
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-stone-500 dark:text-zinc-500 text-[10px] uppercase font-mono tracking-widest mb-1">
                        Technologies tags (Comma lists of names)
                      </label>
                      <input
                        type="text"
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-4 border-b border-stone-200 dark:border-zinc-800 pb-4">
                  ...
                  {!editingCat && (
                    <button
                      onClick={() =>
                        setEditingCat({ id: "", nameEn: "", nameFr: "" })
                      }
                ...
                {!editingCat ? (
                      ...
                      >
                        <div>
                          ...
                          <h4 className="text-stone-900 dark:text-white font-semibold text-sm mt-2">
                            {cat.nameEn}{" "}
                            <span className="text-stone-500 dark:text-zinc-500 font-normal">
                              / {cat.nameFr}
                            </span>
                          </h4>
                        </div>
                  ...
                  >
                    <div className="bg-[#1c1917]/5 dark:bg-[#1c1917]/35 border border-[#d97736]/15 rounded-xl p-4 text-[11px] leading-relaxed text-stone-600 dark:text-zinc-350">
                      Creating or modifying a project category instantly updates
                      filter options on the live portfolio view.
                    </div>
                      ...
                      <tbody className="divide-y divide-stone-200/40 dark:divide-zinc-850/40">
                        {technologies.map((tech) => (
                          ...
                          >
                            ...
                            <td className="py-3.5 px-4 font-mono capitalize text-[#d97736]">
                              {tech.category}
                            </td>
                            <td className="py-3.5 px-4 font-semibold font-mono text-xs">
                              {tech.proficiency}%
                            </td>
                ...
                {!editingExp ? (
                  <div className="overflow-x-auto bg-stone-50/50 dark:bg-neutral-900/20 rounded-2xl border border-stone-200 dark:border-zinc-800 p-4 luxury-glow shadow-sm text-stone-700 dark:text-zinc-300">
                    <table className="w-full text-left border-collapse text-xs">
                      <thead>
                        <tr className="border-b border-stone-200 dark:border-zinc-800 text-stone-500 dark:text-zinc-500 uppercase tracking-widest text-[9px] font-mono select-none">
                          <th className="py-2.5 px-4 col-span-2">
                            Company / Role
                          </th>
                        ...
                        {experiences.map((exp) => (
                          ...
                          >
                            <td className="py-3.5 px-4">
                              ...
                              <span className="text-stone-500 dark:text-zinc-500 text-[10px] font-mono leading-none mt-1">
                                {exp.role}
                              </span>
                            </td>
                            <td className="py-3.5 px-4 font-mono">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-stone-500 dark:text-zinc-500 text-[10px] uppercase font-mono tracking-widest mb-1">
                          End Month/Year (Leave empty if active)
                        </label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="block text-stone-500 dark:text-zinc-500 text-[10px] uppercase font-mono tracking-widest mb-1">
                        Technologies tags context (Comma lists)
                      </label>
                      <input
                        type="text"
                    ...
                    messages.map((msg) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 mb-3 select-none">
                          <div>
                            <span className="text-stone-900 dark:text-white text-xs font-bold">
                              {msg.name}
                            </span>
                            <span className="text-stone-500 dark:text-zinc-500 text-[10px] font-mono ml-2">
                              ({msg.email})
                            </span>
                          </div>
                          <span className="text-stone-505 dark:text-zinc-600 font-mono text-[9px]">
              ...
              <div className="space-y-6">
                ...
                {!editingSeo ? (
                  <div className="space-y-5 text-xs text-stone-700 dark:text-zinc-300">
                    <div className="bg-stone-50/50 dark:bg-neutral-900/20 p-5 rounded-2xl border border-stone-200 dark:border-zinc-800 space-y-4 luxury-glow shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-stone-700 dark:text-zinc-300 font-sans leading-relaxed">
                          {seo.metaDescription}
                        </p>
                      </div>
                      <div>
                        <span className="text-stone-400 dark:text-zinc-500 font-mono text-[9px] uppercase tracking-widest block mb-1">
                          Site Search Tags / Keywords
                        </span>
                  ...
                  >
                    ...
                    <div>
                      <label className="block text-stone-500 dark:text-zinc-400 text-[10px] uppercase font-mono tracking-widest mb-1">
                        Keywords Tags (Comma list)
                      </label>
                      <input
                        type="text"
                        ...
                        onChange={(e) =>
                          setEditingSeo({
                            ...editingSeo,
                            keywords: e.target.value as any,
                          })
                        }
